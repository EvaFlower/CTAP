...
parser.add_argument("-mp", "--load_model_path", type=str, default="results/l2svm_celebahq_with0_pretrainu0_u0.0_s1_r10_i0_w0_gp150_im256_ss1000_ni30000_bs4_ug1_NOTDELETE", help="data path")
...
parser.add_argument("-stop", "--stop", type=bool, default=False)
...
from relgan_F_cls import Relgan
